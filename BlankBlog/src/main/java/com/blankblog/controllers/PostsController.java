package com.blankblog.controllers;
...
import com.blankblog.services.NotificationService;
import com.blankblog.services.PostService;
import com.blankblog.services.UserService;
...
public class PostsController {
	...
	public ModelAndView edit(@Valid Post post, BindingResult bindingResult){		
		...
		// Get author		
		User user = this.userService.findById(post.getId());
		if( user==null ){
			bindingResult.rejectValue("author", "error.post", "Author cannot be null");
		}
		if( !bindingResult.hasErrors() ){
